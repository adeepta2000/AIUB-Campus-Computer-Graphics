...
void startscreen(void)
{
    ...
    glColor3f(1,1,1);
    drawstring(100,370,0.0,"Anirban Saha Anik  (18-36207-1)");
    drawstring(100,290,0.0,"Bishowjit Datta  (18-37372-1)");
    drawstring(100,210,0.0,"Mehedi Hasan Talha  (19-39597-1)");
    glColor3f(1,0.5,0);
    drawstring(700,400,0.0,"SUBMITTED TO:");
    glColor3f(1,1,1);
    drawstring(700,370,0.0,"-----------");
    glColor3f(0,1,0);
